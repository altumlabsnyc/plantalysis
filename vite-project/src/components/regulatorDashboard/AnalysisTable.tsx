import { Button, ClickAwayListener, CssBaseline, InputLabel, MenuItem, TextField } from '@material-ui/core'
...
import { AnalysisTableRow, APPROVED, LabOrder, LabOrderTableRow, MoleculePredict, NOT_APPROVED } from '../UserTypes'
...
const AnalysisTable: React.FC<{ analysis: AnalysisTableRow[] }> = ({ analysis }) => {
    ...
    const [moleculePredictionData, setMoleculePredictionData] =
        useState<MoleculePredict[]>([])
