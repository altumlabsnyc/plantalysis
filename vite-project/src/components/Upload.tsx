            ...
            <div className="flex items-center space-x-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className={`${
                    selectedButton === link.label ? "text-green-600 font-semibold text-xl" : "text-xl"
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center pt-5 pb-6">
            <svg
              ...
              viewBox="0 0 20 16"
            >
               <path stroke="#457F6C" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
            </svg>
            <p className="mb-2 text-sm text-black-500 dark:text-black-400">
              <span className="font-semibold text-3xl text-[#457F6C]">Click to upload or drag and drop</span>
            </p>
        ...
        <tbody>
          ...
          .map((entry, index) => (
            <tr key={index}>
              ...
              <td className="px-6 py-3 text-black-900">{entry.lastUploaded}</td>
              <td className="px-6 py-3 text-black-900">{entry.solvents}</td>
              <td className="px-6 py-3 text-black-900">{entry.percentage}</td>
