...
export const userSpecificInputs: Map<UserRole, Array<Input>> = new Map([
  [
    ...
    [
      ...
      [
        ...
        { name: 'License Type', id: 'license_type', type: 'radio' , options: ['AUCC', 'AUCP', 'AUHC']},
  ...
  export const brandInputs: Array<Input> = [
    ...
    { name: 'Test Options', id: 'option_ABC', type: 'radio', options: ['a', 'b', 'c'] },
    { name: 'Test DropDown', id: 'drop_down', type: 'dropdown', options: ['a', 'b', 'c'] }
  ]
