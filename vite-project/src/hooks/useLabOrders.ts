...
export default function useLabOrders(user: User | null) {
  const fetcher = async () => {
      let ordersError: any,
      ordersData: Array<LabOrder> | null;
 ...
 */
export function getUserClaimedOrders(allOrders: LabOrder[], user: User): Array<LabOrder>{
 ...
 */
export function getUserUnClaimedOrders(allOrders: LabOrder[], user: User): Array<LabOrder>{
