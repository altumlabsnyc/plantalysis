...
import { BaseUser, LabUser, RegulatorUser, ProducerUser, UniversityUser, ConsumerUser } from "@/types/supabaseAlias";
...
export async function handleSignUp(userData: {
    ...
    //   });
      ...
      if (error) {
        ...
        await insertUserDetails({userDetails: userData.userDetails, roleData:userData.roleData});
